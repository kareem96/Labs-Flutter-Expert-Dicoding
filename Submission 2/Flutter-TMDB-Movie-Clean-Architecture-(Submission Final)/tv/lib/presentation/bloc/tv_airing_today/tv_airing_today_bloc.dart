...
class TvAiringTodayBloc extends Bloc<TvAiringTodayEvent, TvAiringTodayState>{
  ...
  FutureOr<void> _onTvAiringToday(OnTvAiringToday event, Emitter<TvAiringTodayState> emit) async{
    ...
    result.fold((failure) {
      ...
      success.isEmpty ? emit(TvAiringTodayEmpty()) : emit(TvAiringTodayHasData(success));
    });
  }
}